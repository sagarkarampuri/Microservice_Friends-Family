...
public class ExceptionControllerAdvice {
	...
	@ExceptionHandler(FriendAndFamilyException.class)
	public ResponseEntity<ErrorInfo> stockExceptionHandler(FriendAndFamilyException exception) {
